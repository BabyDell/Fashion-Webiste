...
//             <div className="w-full h-10 bg-white rounded-2xl mb-4">
//               <input
//                 className="h-full w-full ml-4 bg-transparent outline-0"
...
//             <button className="w-full h-10 bg-black rounded-2xl mb-1  flex items-center justify-center">
...
//             <button className="w-full h-10 bg-black rounded-2xl mb-1 flex items-center justify-center text-white">
